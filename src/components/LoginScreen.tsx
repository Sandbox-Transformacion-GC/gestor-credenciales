    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-100 px-4 dark:bg-slate-900">
      <div className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-lg dark:bg-slate-800">
        <div className="mb-6 text-center">
          <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-brand-100 text-2xl dark:bg-brand-900">
            🔐
          </div>
          <h1 className="text-xl font-semibold text-slate-900 dark:text-slate-100">Gestor de Credenciales</h1>
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Acceso restringido al equipo</p>
        </div>
